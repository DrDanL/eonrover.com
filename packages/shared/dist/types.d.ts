...
export type BuildingKey = 'alloyMine' | 'helioxExtractor' | 'aetherSynthesizer' | 'solarArray' | 'alloyStorage' | 'helioxStorage' | 'aetherStorage' | 'shipyard' | 'researchLab' | 'gateObservatory';
export type ResearchKey = 'alloyProcessing' | 'helioxCombustion' | 'aetherPhysics' | 'propulsionTheory' | 'espionageTech' | 'shieldTech' | 'weaponTech' | 'armourTech' | 'gateTheory';
export type ShipKey = 'scout' | 'transporter' | 'colonyShip' | 'corvette' | 'frigate' | 'recycler' | 'probe';
