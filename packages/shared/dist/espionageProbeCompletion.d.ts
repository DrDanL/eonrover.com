 ...
 */
export declare function settleCanonicalEspionageProbe(database: EspionageProbeCompletionDatabase, missionId: string, currentTime?: Date): Promise<EspionageProbeCompletionOutcome>;
