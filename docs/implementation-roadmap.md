...
| Stage 6B | In progress | Atomic account-wide research start/cancellation, snapshots, and post-commit deterministic scheduling are being added; completion/reconciliation remain deferred. |
