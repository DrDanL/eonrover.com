...
| Stage 13B1–B3 | Complete | A typed shared defence catalogue now makes only Flak Turret constructible. Shipyard starts persist a legacy-safe canonical Flak marker, while completion, cancellation, early-job recovery, and 30-second reconciliation remain PostgreSQL-authoritative and increment Defence inventory exactly once. Rail Battery and Planetary Shield stay unavailable. Deterministic combat fixtures record the current six-round Corvette/defence outcomes without changing balance. |
...
**Stage 13B balance observation:** At equal Weapon/Shield/Armour levels 0, 3, and 6, the current deterministic resolver has 10 Corvettes destroy one Flak Turret in four rounds, while 10 Corvettes versus one Rail Battery or Planetary Shield, 10 versus three Corvettes, and 20 Corvettes versus 10 Flak Turrets all draw with no losses after the fixed six-round cap. These are recorded fixtures, not a balance change.
