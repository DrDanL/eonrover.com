...
- Stage 10B1 adds shared pure Transporter-only cargo-capacity and fixed-speed round-trip planning. It has no persistence, mission lifecycle, API, worker, or player UI activation yet.
