...
- The deterministic Stage 13B combat fixtures explicitly retain the current six-round model: at equal technology levels 0, 3, and 6, 10 Corvettes defeat one Flak Turret in four rounds, while the covered Rail Battery, Planetary Shield, Corvette control, and Flak-swarm cases draw without losses at the round cap. No combat values were changed.
