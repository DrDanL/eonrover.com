...
export const ERROR_CODES = {
  ...
  CONSTRUCTION_NOT_CANCELLABLE: 'CONSTRUCTION_NOT_CANCELLABLE',
  RESEARCH_IN_PROGRESS: 'RESEARCH_IN_PROGRESS',
  RESEARCH_REQUIREMENTS_NOT_MET: 'RESEARCH_REQUIREMENTS_NOT_MET',
  RESEARCH_EFFECT_UNAVAILABLE: 'RESEARCH_EFFECT_UNAVAILABLE',
  RESEARCH_NOT_CANCELLABLE: 'RESEARCH_NOT_CANCELLABLE',
  PREREQUISITES_NOT_MET: 'PREREQUISITES_NOT_MET',
  PLANET_FIELDS_FULL: 'PLANET_FIELDS_FULL',
  ...
  FLEET_MISSIONS_UNAVAILABLE: 'FLEET_MISSIONS_UNAVAILABLE',
  ADMIN_PORTAL_UNAVAILABLE: 'ADMIN_PORTAL_UNAVAILABLE',
} as const;
