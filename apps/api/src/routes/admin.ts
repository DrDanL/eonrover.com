...
router.post('/users/:id/rename', requireRole('ADMIN'), async (req, res) => {
...
router.delete('/alliances/:id', requireRole('ADMIN'), async (req, res) => {
...
router.delete('/jobs/:queue/:id', requireRole('ADMIN'), async (req, res) => {
